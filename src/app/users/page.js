    ...
    <UserNavigation isAdmin={session?.user.isAdmin}/>
      ...
      <div className='flex flex-col my-12 justify-around w-5/6 mx-auto py-8
        ...
        <div className='flex justify-around my-2'>
          ...
          <p className='text-lg font-medium w-20 lg:w-40 border-b-2 border-green-700'>Email</p>
          <p className='text-lg font-medium w-20 lg:w-40 border-b-2 border-green-700'>User Type</p>
          <p className='text-lg font-medium w-20 lg:w-40 border-b-2 border-green-700'>ID</p>
          <p className='text-lg font-medium w-20 lg:w-40 border-b-2 border-green-700'>Delete</p>
        </div>
        {users.length > 0 && users.map((user) => (
                <div key={user._id} className='flex justify-around my-2'>
                    <p className='w-20 lg:w-40'>{user.name}</p>
                    <p className='w-20 lg:w-40 text-ellipsis overflow-hidden'>{user.email}</p>
                    ...
                    <p className='w-20 lg:w-40 text-ellipsis overflow-hidden'>{user._id}</p>
                    <div className='w-20 lg:w-40'>
