...
export default function About() {
  return (
    <div name='about'  className="flex flex-col items-center gap-4  my-12">
      ...
      appetizers to mouthwatering main courses and decadent desserts,
       our menu showcases a symphony of flavors sure to please even the 
      ...
      for a dine-in experience or place your delivery order online with 
      just a few clicks. Our friendly staff is always ready to assist you 
      with any inquiries or special requests, ensuring that your 
