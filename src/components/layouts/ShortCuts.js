...
export default function ShortCuts() {
  return (
    <div className="hidden md:block flex-col items-center justify-center top-[30%] right-2 fixed 
                    py-1 px-2 bg-green-700 rounded-3xl w-26 ">
         <p className="my-8 text-md text-center bg-white text-green-700
